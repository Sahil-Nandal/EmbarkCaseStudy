...
const homePage = () => {
    return (
        <div className="homePage">
            <h1 className='Bankheading'><u>Richie Rich Reserve Bank</u></h1>
            <div className="forms">
                <form action="" class="form_main">
                    ...
                    <div class="inputContainer">
                        ...
                        <input type="password" class="inputField" id="password" placeholder="Repeat Password"></input>
                    </div>
                ...
                <form action="" class="form_main">
                    ...
                    <Link to="/userPage"><button id="button">Submit</button></Link>
                    <a class="forgotLink" href="#">Forgot your password?</a>
                </form>
            </div>
